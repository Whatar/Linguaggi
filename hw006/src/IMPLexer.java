...
public class IMPLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TOSTRING", "CONCAT", "BOOL", "NOT", "AND", "OR", "EQQ", "NEQ", "LT", 
			"LEQ", "GEQ", "GT", "WHILE", "OUT", "SKIPP", "IF", "THEN", "ELSE", "LPAR", 
			"RPAR", "LBRACE", "RBRACE", "LSQUARE", "RSQUARE", "PLUS", "TIMES", "MINUS", 
			"DIV", "MOD", "POW", "ASSIGN", "SEMICOLON", "NAT", "POS", "DIGIT", "POSDIGIT", 
			"STRING", "ESC_SEQ", "HEX_DIGIT", "UNICODE_ESC", "ID", "WS"
		};
	}
