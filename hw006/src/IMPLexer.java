...
public class IMPLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOOL", "NOT", "AND", "OR", "EQQ", "NEQ", "LT", "LEQ", "GEQ", "GT", "WHILE", 
			"OUT", "SKIPP", "IF", "THEN", "ELSE", "LPAR", "RPAR", "LBRACE", "RBRACE", 
			"PLUS", "TIMES", "MINUS", "DIV", "MOD", "POW", "ASSIGN", "SEMICOLON", 
			"NAT", "POS", "DIGIT", "POSDIGIT", "ID", "WS"
		};
	}
